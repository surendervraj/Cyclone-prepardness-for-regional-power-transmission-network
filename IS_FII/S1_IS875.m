...
for i = 1:1:length(Edges_inside)
    ...
    Edges_inside(i,2) = Edges(Edge11,7);
end
...
no_of_simul = 1000;
 ...
 for p = 1:1:length(no_of_towers)
     ...
     for q = 1:1:length(Hard_ratio)
        ...
        LOF_IS875_FII_1(p,q) = (1- mean(LOF_array))*100;
        Damage_IS875_FII_1(p,q) = mean(Damage_Matrix(:,3));
        fprintf('towers%d\n',nt)
        fprintf('hard%d\n',hr)
...
save('LOF_IS875_FII_1','LOF_IS875_FII_1')
save('Damage_IS875_FII_1','Damage_IS875_FII_1')
